...
import {Modal, View, StyleSheet, Image, TouchableOpacity, Text, TextInput, ScrollView} from "react-native";
...
const defaultModalHeight = responsiveHeight(70);
interface Props {
    modalIsVisible: boolean,
    onIconPress: () => void,
    travelId?: number,
}
const ScreenModal: React.FC<Props> = ({modalIsVisible, onIconPress, travelId, children}) => {
